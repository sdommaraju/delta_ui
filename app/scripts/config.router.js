  ...
  .config(['$stateProvider', '$urlRouterProvider','USER_ROLES',
    ...
    .state('app.opening-details', {
      ...
      .state('app.candidates', {
        ...
        resolve: {
            deps: ['$ocLazyLoad', function ($ocLazyLoad) {
              return $ocLazyLoad.load('scripts/controllers/candidates/candidates.js')
              }]
          },
          data: {
            title: 'Candidates',
      ...
      .state('app.candidatedetails', {
        templateUrl: 'views/candidates/candidateDetails.html',
        resolve: {
            deps: ['$ocLazyLoad', function ($ocLazyLoad) {
              return $ocLazyLoad.load('scripts/controllers/candidates/candidatedetails.js')
              }]
          },
          data: {
            title: 'candidatesDetailsCtrl',
          },
          url: '/candidatedetails'
      })

      .state('app.candidateuploaddata', {
        templateUrl: 'views/candidates/candidateUploadData.html',
        resolve: {
            deps: ['$ocLazyLoad', function ($ocLazyLoad) {
              return $ocLazyLoad.load('scripts/controllers/candidates/candidateuploaddata.js')
              }]
          },
          data: {
